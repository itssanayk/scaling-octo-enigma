...
<head>
    ...
    define('bankName', 'IndianDhan Bank',true);
...
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Sanay Kumar</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
